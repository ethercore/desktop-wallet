        ...
        submenu: [
          {
            ...
            click() {
              ...
              if (ethereumNode.isEth) {
                ...
                if (process.platform === 'darwin') {
                  userPath += '/Library/EtherCore/keystore';
                }
                ...
                if (
                  ...
                  userPath += '/.ethercore/keystore';
                }

                if (process.platform === 'win32') {
                  userPath = `${Settings.appDataPath}\\EtherCore\\keystore`;
                }
              }
  ...
  helpMenu.push(
    {
      ...
      click() {
        shell.openExternal('https://discord.gg/3XQRbNk');
      }
    },
    {
      label: i18n.t('mist.applicationMenu.help.reddit'),
      click() {
        shell.openExternal('https://www.reddit.com/u/ethercore');
      }
    },
    {
      label: i18n.t('mist.applicationMenu.help.reportBug'),
      click() {
        shell.openExternal('https://github.com/ethercore/desktop-wallet/issues');
      }
    }
  );
