...
// should be       'https://raw.githubusercontent.com/ethercore/desktop-wallet/master/clientBinaries.json'
const BINARY_URL =
   'https://raw.githubusercontent.com/ethercore/desktop-wallet/master/clientBinaries.json';

const ALLOWED_DOWNLOAD_URLS_REGEX = /^https:\/\/(?:(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.)?ethercore\.org\/|github\.com\/|gethstore\.blob\.core\.windows\.net\/|bintray\.com\/artifact\/download\/karalabe\/ethereum\/)(?:.+)/; // eslint-disable-line max-len
